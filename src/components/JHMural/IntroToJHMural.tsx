...
export default function IntroToJHMural() {
    ...
    const handleVisitWebsite = () => {
        window.open('https://jhmuralproject.com', '_blank')
    }
    ...
    if (isTablet) {
        return (
            <div className="flex w-full align-center justify-center">
                <div className="flex flex-col items-start justify-center w-full gap-[var(--spacing-2xl)] py-[var(--spacing-2xl)]">
                    <div className="inline-block">
                        <h2 className="h1 text-[var(--color-primary)] inline-block">
                            {introToJH.heading}
                        </h2>
    ...
    if (isDesktop1440px) {
        return (
            <div className="w-full flex justify-end">
                <div className="flex flex-col items-start justify-center w-[800px] max-w-[800px] p-[var(--spacing-lg)] gap-[var(--spacing-lg)]">
    ...
    return (
        <div className="w-full flex justify-end">
            <div className="flex flex-col items-start justify-center w-[1000px] max-w-[1000px] p-[var(--spacing-lg)] gap-[var(--spacing-lg)]">
                <div className="flex flex-col items-start justify-center gap-[var(--spacing-xs)]">
                    <h2 className="h1 text-[var(--color-primary)]">
                        {introToJH.heading}
                    </h2>
