...
const MenuOverlay: React.FC<MenuOverlayProps> = ({ isOpen, onClose }) => {
  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Menu Panel */}
        <div
          className={`fixed top-0 left-0 w-full h-full bg-[var(--black)] z-[201] ${
            isOpen ? 'animate-slideInMenuMobile' : 'animate-slideOutMenuMobile pointer-events-none'
          }`}
        >
          <div className="h-full flex flex-col p-[var(--spacing-2xl)]">
            {/* Close Button */}
  ...
  if (isTablet) {
    return (
      <>
        ...
        >
          <div className="h-full flex flex-col p-[var(--spacing-3xl)]">
            {/* Close Button */}
  ...
  return (
    <>
      ...
      >
        <div className="h-full flex flex-col p-[var(--spacing-4xl)]">
          {/* Close Button */}
